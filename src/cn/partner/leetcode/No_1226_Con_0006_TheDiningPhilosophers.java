...
class DiningPhilosophers {
    ...
    public void wantsToEat(int philosopher,
        ...
        Semaphore rightFork = semaphores[(philosopher + 1) % 5];
        Semaphore leftFork = semaphores[philosopher];
...
// Test
public class No_1226_Con_0006_TheDiningPhilosophers {
...
/**
 * Output:
 * [2,1,1][0,1,1][2,2,1][0,2,1][2,0,3][0,0,3][2,1,2][0,1,2][2,2,2][0,2,2][1,1,1][1,2,1][1,0,3][1,1,2][1,2,2][3,1,1][3,2,1][3,0,3][3,1,2][3,2,2][4,1,1][4,2,1][4,0,3][4,1,2][4,2,2]
 */
